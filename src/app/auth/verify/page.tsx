...
type VerifyFromData = z.infer<typeof vericationCodeSchema>;
...
export default function VerifcationPage() {
  ...
  const {
    ...
    resolver: zodResolver(vericationCodeSchema),
    mode: "onChange",
  ...
  const isButtonDisabled =
    loading || !codeValue || codeValue.length !== 6 || !isValid;
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            ...
            <input
              ...
              maxLength={6}
              placeholder="000000"
              className="w-full px-3 text-black py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-gray-900 text-center text-2xl font-mono tracking-widest"
            />
            {errors.code && (
